...
import { Products } from "../admin/Admin";
...
const RelateProduct = ({ productData }: { productData: Products[]}) => {
  ...
  return (
    <div className="section-1">
      ...
      <div className="content flex ">
        <FcPrevious className="icon" style={{ width: "50", height: "50" }}
        onClick={handlePrev} />
        ...
        <div className="content-right">
          ...
          {/* <h2>{relateProduct?.star}</h2> */}
          <h2 className="price">
            Price: <span style={{ color: "red" }}>{productData[prev]?.price}$</span>
          </h2>
        ...
        <FcNext className="icon" style={{ width: "50", height: "50" }} 
...
const Home = () => {
  ...
  const [relateProduct, setRelaPro] = useState<Products[]>([]);
  ...
  return (
    <>
      ...
      <TableProduct productData={productsContext.products} />
    </>
  );
};
